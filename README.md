...
The server expects an *env.js* file in the root directory with the following variables defined:
...
* `TMDB_API_KEY` an API-Key from [themoviedb.org](https://www.themoviedb.org/documentation/api)
...
Served to `localhost:61008` if you didn't specify another port in *env.js*.
...
### API Endpoints
    ...
    GET     /search/:search_str     // return search results
